  ...
  template: `
    <header class="sticky top-0 z-30 bg-background border-b border-border">
      <div class="max-w-6xl mx-auto px-4 h-[72px] flex items-center justify-between gap-6">
        ...
        <!-- Nav desktop (≥860px) -->
        <nav class="hidden min-[860px]:flex items-center gap-0.5 flex-1 justify-center" aria-label="Navegación principal">
          ...
          <div class="relative group">
            ...
            <div class="absolute top-full left-0 pt-1 invisible group-hover:visible group-focus-within:visible opacity-0 group-hover:opacity-100 group-focus-within:opacity-100
                        transition-all duration-150 pointer-events-none group-hover:pointer-events-auto group-focus-within:pointer-events-auto">
              <div class="bg-surface border border-border rounded-[10px] shadow-[0_12px_24px_rgba(28,35,33,0.08)] py-1.5 min-w-[210px]">
                <a routerLink="/quienes-somos/directiva"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Directiva
                </a>
                <a routerLink="/quienes-somos/mision-vision-valores"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Misión, Visión y Valores
                </a>
                <a routerLink="/quienes-somos/historia"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Historia
                </a>
                <a routerLink="/quienes-somos/principios-doctrinales"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Principios Doctrinales
                </a>
                <a routerLink="/quienes-somos/que-creemos"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Qué Creemos
                </a>
              </div>
          ...
          <div class="relative group">
            ...
            <div class="absolute top-full left-0 pt-1 invisible group-hover:visible group-focus-within:visible opacity-0 group-hover:opacity-100 group-focus-within:opacity-100
                        transition-all duration-150 pointer-events-none group-hover:pointer-events-auto group-focus-within:pointer-events-auto">
              <div class="bg-surface border border-border rounded-[10px] shadow-[0_12px_24px_rgba(28,35,33,0.08)] py-1.5 min-w-[210px]">
                <a routerLink="/liderazgo/mujer"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Ministerio de la Mujer
                </a>
                <a routerLink="/liderazgo/varones"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Ministerio de Varones
                </a>
                <a routerLink="/liderazgo/jovenes"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Jóvenes y Adolescentes
                </a>
                <a routerLink="/liderazgo/infantil"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Ministerio Infantil
                </a>
                <a routerLink="/liderazgo/musica"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Ministerio de Música
                </a>
                <a routerLink="/liderazgo/social"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Proyección Social
                </a>
              </div>
          ...
          <div class="relative group">
            ...
            <div class="absolute top-full left-0 pt-1 invisible group-hover:visible group-focus-within:visible opacity-0 group-hover:opacity-100 group-focus-within:opacity-100
                        transition-all duration-150 pointer-events-none group-hover:pointer-events-auto group-focus-within:pointer-events-auto">
              <div class="bg-surface border border-border rounded-[10px] shadow-[0_12px_24px_rgba(28,35,33,0.08)] py-1.5 min-w-[190px]">
                <a routerLink="/recursos/plan-estrategico"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Plan Estratégico
                </a>
                <a routerLink="/recursos/plan-operativo"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Plan Operativo
                </a>
                <a routerLink="/recursos/accesos-adicionales"
                   class="block px-3 py-[9px] rounded-md text-sm text-foreground hover:bg-background hover:text-primary transition-colors">
                  Accesos Adicionales
                </a>
              </div>
          ...
          <a routerLink="/ubicanos" routerLinkActive="text-primary font-semibold"
             class="px-3 py-2 rounded text-sm font-medium text-foreground hover:text-primary transition-colors">
            Ubícanos
          </a>
        </nav>
